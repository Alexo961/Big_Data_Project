...
public class JoinDriver2 extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		MultipleInputs.addInputPath(conf, AInputPath, TextInputFormat.class,  FirstJobFirstMapperFile.class);
		MultipleInputs.addInputPath(conf, BInputPath, TextInputFormat.class,  FirstJobSecondMapperFile.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int exitCode = ToolRunner.run( new JoinDriver2(), args);
